...
import starU from '../../images/starUnPaint.svg'
import location from '../../images/Subtract.svg'
        ...
        <div className="information">
            <div className="info-page">
                ...
                <div className="rating-section">
                    ...
                    <h1>{data[0]?.title}</h1>
                    <p>By <span>{data[0]?.author}</span>, {data[0]?.createdAt}</p>
                    <div className="edition">{data[0]?.editionNumber}</div>
                    </div>
                    <div className="current-rating">
                        ...
                        {[...new Array(totalStars)].map((arr, index) => {
                            ...
                            <img src={starU} alt='star' />
                            )
                            })}
                        <p>{data[0]?.rate}.0 Ratings</p>
                        </div>
                        <span>{data[0]?.curentlyReading} Currently reading</span>
                    </div>
                    <div className="status-part">
                        ...
                        <div className="current-status">
                            ...
                            <span><img src={location} alt="" /><p>CS A-15</p></span>
                        </div>
                    </div>
                    <div className="order">
                ...
                <h6><span>Other</span> Books</h6>
                <div className="otherBooks">
                {infoData?.map((element) => {
                    return (
                        <div className='books__small'>
                    <img src={element?.img} alt='book small' />
                    <h3>{element?.title}</h3>
                    <h4>{element?.author}, {element?.createdAt}</h4>
                    <p>{element?.rate}/5</p>
                </div>
                    )
                })}
